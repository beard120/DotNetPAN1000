    ...
    public class DBEntityHelper : IDBEntityHelper
    {
        ...
        public List<T> GetDataList<T>(string queryString, params DbParameter[] parameters)
        {
            ...
            else
            {
                ...
                {
                    sql = "select " + fields.ToString() + " from " + tableName + " " + queryString + " limit 0,1000";
                }
                else
                {
                    sql = "select " + fields.ToString() + " from " + tableName + " where " + queryString + " limit 0,1000";
                }
        ...
        public List<T> GetDataList<T>(int num, string where, string sort, params DbParameter[] parameters)
        {
            ...
            if (num > 0)
            {
                sql = "select " + fields.ToString() + " from " + tableName + " " + where + " " + sort + " limit 0," + num;
            }
            else
            {
        ...
        public RT InsertDataAndGetID<T, RT>(T entity)
        {
            ...
            string sql = "insert into " + tableName + "(" + fields + ") values(" + parames + ");select LAST_INSERT_ID();";
